...
void IO_Init(void)
{
	#if (IC_MODEL == SC92F7547)  //SC92F7547引脚定义
	...
	#if (IC_MODEL == SC92F7546)  //SC92F7546引脚定义
	P0CON = 0xFF;  //设置P0为强推挽模式
	P0PH  = 0x00;
	P1CON = 0x00;  //设置P1为高阻输入模式
	P1PH  = 0x00;
	...
	#if (IC_MODEL == SC92F7543)  //SC92F7543引脚定义
	...
	P2CON = 0x00;  //设置P2为高阻带上拉模式
	P2PH  = 0x00;
	P3CON = 0x00;  //设置P3为强推挽模式
	P3PH  = 0x00;
	P4CON = 0x00;  //设置P4为强推挽模式
	P4PH  = 0x00;
//	SC92F7543_NIO_Init(); //未引出IO口配置
	#endif
